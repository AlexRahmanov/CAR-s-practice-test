...
## CARs Practice
Added a separate CARs Practice bank using 50 questions from the original typed CARs Test #1 included in the supplied Cars.zip, matched to the original answer key. Question wording and A/B/C/D answer wording were not rewritten.


## CARs v6 expanded bank
CARs Practice now contains 255 source-derived questions:
- 50 questions from Original CARs Test #1 (Book 1)
- 50 questions from Original CARs Test #2 (Book 1)
- 50 questions from Original CARs Test #3 (Book 1)
- 50 questions from Original CARs Test #4 (Book 1)
